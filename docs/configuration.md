...
The package script does not read a home-directory config by default. The running core may still use a user-owned config in an installation-specific integration; keep that layer outside the source archive.
